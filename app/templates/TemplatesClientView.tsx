...
export default function TemplatesClientView({ initialTemplates, totalCount, hasError = false }: { initialTemplates: Template[], totalCount?: number, hasError?: boolean }) {
        ...
        <ListPageShell activeTab="none">
            <div className="w-full max-w-7xl mx-auto flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-4">
                    {hasError && (
                        <StateCard variant="error" title={t("templatesPage.errorTitle")} description={t("templatesPage.errorDescription")} />
                    )}
                    ...
                    {!hasError && myTemplates.length === 0 && (
                        <StateCard variant="empty" title={t("templatesPage.notFound")} description={t("templatesPage.createFirst")} />
                    )}
                </div>
            </div>
