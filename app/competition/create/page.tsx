...
import {createCompetitionInfrastructure, getCompetitionSeriesCount, getCompetitionSeriesListAction} from './actions';
...
export default function CreateCompetitionPage() {
    ...
    // useEffect(() => {
    //     // console.log('currentAuid:', currentAuid);
    //
    //     if (!currentAuid) return;
    //
    //     getCompetitionSeriesCount(currentAuid)
    //         .then(count => {
    //             console.log(count);
    //         });
    // }, [currentAuid]);
