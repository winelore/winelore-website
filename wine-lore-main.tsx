    ...
    <Popover>
      ...
      <PopoverContent align="end" className="w-56 p-0">
        ...
        <div className="flex gap-2 border-b border-border p-3">
          <a
            href="#"
            className="flex flex-1 flex-col items-center justify-center gap-1 rounded-full bg-secondary py-3 text-sm font-medium text-card-foreground transition-colors hover:bg-secondary/80"
          >
          ...
          <a
            href="#"
            className="flex flex-1 flex-col items-center justify-center gap-1 rounded-full bg-transparent py-3 text-sm font-medium text-red-500 transition-colors hover:bg-muted/50"
          >
            <LogOut className="mb-0.5 h-6 w-6" />
            <span>Log Out</span>
          </a>
        </div>
