const en = {
  ...
  outcomePolicyModal: {
    createTitle: "Create Outcome Policy Script",
    editTitle: "Edit Outcome Policy Script",
    subtitle: "Configure the script for this outcome policy.",
    close: "Close",
    nameLabel: "Policy Name",
    readOnlyLabel: "(read only)",
    namePlaceholder: "e.g. Final Score Calculation...",
    scriptLabel: "Script",
    loading: "Loading...",
    cancel: "Cancel",
    save: "Save Changes",
    saving: "Saving...",
    nameRequiredError: "Please enter an outcome policy name.",
    nameDuplicateError: "A policy with this name already exists. Please choose a different name.",
    loadError: "Failed to load the policy script for editing.",
    editionNotFoundError: "Could not find the script edition to update.",
    saveError: "Failed to save the outcome policy script.",
    saveErrorWithId: "Failed to save the outcome policy script. (Error ID: {{id}})",
  },
} as const
