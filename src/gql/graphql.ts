...
export type GetReplicaCandidatesQuery = { commissionReplica: { id: string, status: CommissionReplicaStatus, commission: { id: string, candidates: Array<{ id: string }> }, replicaCandidates: Array<{ id: string, status: CommissionReplicaCandidateStatus, candidate: { id: string, anonymizedCode: string | null, beverageType: BeverageType, sample: { id: string, volumeMl: number | null, batch: { id: string, vintage: number | null, beverage: { type: WineType, id: string, name: string, status: BeverageStatus, origin: { latitude: number, longitude: number } | null, producers: Array<{ auid: Array<number> }> } } } } }> } | null };
