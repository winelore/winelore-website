...
export type GetCommissionQuery = { commission: { id: string, name: string, status: CommissionStatus, plannedStartAt: string | null, startedAt: string | null, endedAt: string | null, createdAt: string, competition: { id: string, name: string, holders: Array<Array<number>> }, members: Array<{ id: string, auid: Array<number>, role: CommissionMemberRole, isReady: boolean }> } | null };
...
export type GetCompetitionPageQuery = { competition: { id: string, name: string, status: CompetitionStatus, startedAt: string | null, plannedStartAt: string | null, plannedEndAt: string | null, endedAt: string | null, holders: Array<Array<number>>, series: { id: string, name: string, status: CompetitionSeriesStatus } } | null, commissionsByCompetition: { items: Array<{ id: string, name: string, status: CommissionStatus, startedAt: string | null, endedAt: string | null }> } };
...
export type GetDashboardCompetitionsQuery = { competitions: { items: Array<{ id: string, name: string, status: CompetitionStatus, startedAt: string | null, plannedStartAt: string | null, plannedEndAt: string | null, endedAt: string | null, holders: Array<Array<number>>, series: { id: string, name: string, status: CompetitionSeriesStatus } }> } };
