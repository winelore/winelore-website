...
export type GetBeverageQuery = { beverage: { id: string, name: string, status: BeverageStatus, typeId: string, schemaEditionIds: string, attributes: unknown, createdAt: string, producers: Array<{ id: string, producerId: string, role: ProducerRole }>, origin: { latitude: number, longitude: number } | null } | null };
...
export type SubmitBeverageForReviewMutation = { submitBeverageForReview: { id: string, name: string, status: BeverageStatus, typeId: string, attributes: unknown, producers: Array<{ id: string, producerId: string, role: ProducerRole }>, origin: { latitude: number, longitude: number } | null } };
...
export type ChangeBeverageNameMutation = { changeBeverageName: { id: string, name: string, status: BeverageStatus, typeId: string, attributes: unknown, producers: Array<{ id: string, producerId: string, role: ProducerRole }>, origin: { latitude: number, longitude: number } | null } };
...
export type ChangeBeverageOriginMutation = { changeBeverageOrigin: { id: string, name: string, status: BeverageStatus, typeId: string, attributes: unknown, producers: Array<{ id: string, producerId: string, role: ProducerRole }>, origin: { latitude: number, longitude: number } | null } };
...
export type UpdateBeverageAttributesMutation = { updateBeverageAttributes: { id: string, name: string, status: BeverageStatus, typeId: string, attributes: unknown, producers: Array<{ id: string, producerId: string, role: ProducerRole }>, origin: { latitude: number, longitude: number } | null } };
...
export type RegisterBeverageProducerMutation = { registerBeverageProducer: { id: string, name: string, status: BeverageStatus, typeId: string, attributes: unknown, producers: Array<{ id: string, producerId: string, role: ProducerRole }>, origin: { latitude: number, longitude: number } | null } };
...
export type UnregisterBeverageProducerMutation = { unregisterBeverageProducer: { id: string, name: string, status: BeverageStatus, typeId: string, attributes: unknown, producers: Array<{ id: string, producerId: string, role: ProducerRole }>, origin: { latitude: number, longitude: number } | null } };
...
export type CreateBeverageMutation = { createBeverage: { id: string, name: string, status: BeverageStatus, typeId: string, attributes: unknown, producers: Array<{ id: string, producerId: string, role: ProducerRole }>, origin: { latitude: number, longitude: number } | null } };
...
export type GetBeveragesQuery = { beverageCount: number, beverages: { items: Array<{ id: string, name: string, status: BeverageStatus, typeId: string, attributes: unknown, producers: Array<{ id: string, producerId: string, role: ProducerRole }>, origin: { latitude: number, longitude: number } | null }> } };
...
export type GetReplicaCandidatesQuery = { commissionReplica: { id: string, status: CommissionReplicaStatus, currentPanelId: string | null, commission: { id: string, panels: Array<{ id: string, name: string, candidates: Array<{ id: string }> }> }, replicaPanels: Array<{ id: string, status: CommissionReplicaPanelStatus, currentCandidateId: string | null, chaoticCurrentCandidateChangesEnabled: boolean, panel: { id: string, name: string }, replicaCandidates: Array<{ id: string, status: CommissionReplicaCandidateStatus, candidate: { id: string, anonymizedCode: string | null, beverageType: { id: string, code: string, name: string }, sample: { id: string, volumeMl: number | null, attributes: unknown, batch: { id: string, attributes: unknown, beverage: { id: string, name: string, status: BeverageStatus, attributes: unknown, producers: Array<{ producerId: string }>, origin: { latitude: number, longitude: number } | null } } } } }> }> } | null };
...
export type GetBeverageDetailsMapQuery = { beverage: { id: string, name: string, status: BeverageStatus, typeId: string, attributes: unknown, createdAt: string, producers: Array<{ id: string, producerId: string, role: ProducerRole }>, origin: { latitude: number, longitude: number } | null } | null };
...
export type GetMyBeveragesQuery = { beverageCount: number, beverages: { items: Array<{ id: string, name: string, status: BeverageStatus, typeId: string, attributes: unknown, producers: Array<{ id: string, producerId: string, role: ProducerRole }>, origin: { latitude: number, longitude: number } | null }> } };
