...
export type GetCommissionsQuery = { commissions: { items: Array<{ id: string, name: string, status: CommissionStatus, replicas: Array<{ members: Array<{ auid: Array<number>, role: CommissionReplicaMemberRole }> }> }> } };
