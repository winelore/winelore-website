...
export type GetBeverageQuery = { beverage: { id: string, name: string, status: BeverageStatus, typeId: string, schemaEditionIds: string, attributes: unknown, createdBy: Array<number>, createdAt: string, producers: Array<{ id: string, auid: Array<number> | null, producerId: string | null, role: ProducerRole }>, origin: { latitude: number, longitude: number } | null } | null };
...
export type SetCommissionDiscussionPolicyMutation = { setCommissionDiscussionPolicy: { id: string, discussionPolicy: DiscussionPolicy } };
...
export const SetCommissionDiscussionPolicyDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SetCommissionDiscussionPolicy"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"policy"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DiscussionPolicy"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"setCommissionDiscussionPolicy"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"policy"},"value":{"kind":"Variable","name":{"kind":"Name","value":"policy"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"discussionPolicy"}}]}}]}}]} as unknown as DocumentNode<SetCommissionDiscussionPolicyMutation, SetCommissionDiscussionPolicyMutationVariables>;
