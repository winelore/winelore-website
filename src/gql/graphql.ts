...
export type GetCommissionQuery = { commission: { id: string, name: string, status: CommissionStatus, startedAt: string | null, endedAt: string | null, createdAt: string, plannedDates: { start: string | null, end: string | null } | null, candidates: Array<{ id: string }>, competition: { id: string, name: string, holders: Array<Array<number>>, wineJumperMiniGameEnabled: boolean, voiceCommentsEnabled: boolean, propertyCommentsEnabled: boolean, beverageOriginDuringEvaluationEnabled: boolean }, replicas: Array<{ id: string, name: string | null, type: CommissionReplicaType, status: CommissionReplicaStatus, currentCandidateId: string | null, members: Array<{ id: string, auid: Array<number>, role: CommissionReplicaMemberRole, isReady: boolean }>, replicaCandidates: Array<{ id: string, status: CommissionReplicaCandidateStatus, candidate: { id: string, anonymizedCode: string | null } }> }> } | null };
...
export type GetReplicaCandidatesQuery = { commissionReplica: { id: string, status: CommissionReplicaStatus, commission: { id: string, candidates: Array<{ id: string }> }, replicaCandidates: Array<{ id: string, status: CommissionReplicaCandidateStatus, candidate: { id: string, anonymizedCode: string | null, sample: { id: string, volumeMl: number | null, batch: { id: string, vintage: number | null, beverage: { id: string, name: string, status: BeverageStatus, origin: { latitude: number, longitude: number } | null, producers: Array<{ auid: Array<number> }> } } } } }> } | null };
...
export type GetMyBeveragesQuery = { wines: { items: Array<{ id: string, name: string, status: BeverageStatus, type: WineType, producers: Array<{ id: string, auid: Array<number>, role: ProducerRole }>, origin: { latitude: number, longitude: number } | null }> } };
