...
export type DevGetCommissionReplicasByCommissionQuery = { commissionReplicasByCommission: Array<{ id: string, type: CommissionReplicaType, members: Array<{ id: string, auid: Array<number>, role: CommissionReplicaMemberRole }> }> };
