...
export type GetDashboardCompetitionsQuery = { competitions: { items: Array<{ id: string, name: string, status: Types.CompetitionStatus, startedAt: string | null, plannedStartAt: string | null, plannedEndAt: string | null, endedAt: string | null, holders: Array<Array<number>>, series: { id: string, name: string, status: Types.CompetitionSeriesStatus } }> } };
