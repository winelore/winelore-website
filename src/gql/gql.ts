...
const documents: Documents = {
    ...
    "\n  mutation StartCompetition($id: ID!) {\n      startCompetition(id: $id) {\n          id\n          status\n          startedAt\n      }\n  }\n": types.StartCompetitionDocument,
    "\n  query GetWines($limit: Int) {\n    wines(limit: $limit) {\n      items {\n        id\n        name\n        status\n        type\n        producers {\n          id\n          auid\n          role\n        }\n      }\n    }\n  }\n": types.GetWinesDocument,
